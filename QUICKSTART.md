...
2. **`firestore.indexes.json`** - Database indexes for optimal queries
...
2. Fill out the form
3. Submit
4. Check Firestore emulator UI at http://localhost:4000
...
├── docs/
│   ├── firestore-registration-implementation-plan.md  ← NEW
│   └── registration-data-model-analysis.md      ← NEW
├── api/
│   └── internal/
│       ├── domain/
│       │   └── registration.go                  ← NEW
