 ...
 * /api/v1/flash-news:
 *   get:
 *     summary: Get active flash news
 *     description: Returns currently active flash news based on date range and active status. Public endpoint.
 *     tags:
 *       - Content
 *     responses:
 *       200:
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Query for active flash news within date range
    ...
    console.error('Error fetching active flash news:', err);
