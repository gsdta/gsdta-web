...
| Production | `app.gsdta.com` | `main` | `gsdta-web` | `YOUR_PROJECT_ID` |
...
gcloud run services describe gsdta-web --region=us-central1 --project=YOUR_PROJECT_ID
```
...
# Production logs
gcloud run services logs read gsdta-web --region=us-central1 --project=YOUR_PROJECT_ID --limit=50
```
...
```bash
# List revisions
gcloud run revisions list --service=gsdta-web --region=us-central1 --project=YOUR_PROJECT_ID

# Route traffic to specific revision
gcloud run services update-traffic gsdta-web --region=us-central1 --project=YOUR_PROJECT_ID --to-revisions=REVISION_NAME=100
```
