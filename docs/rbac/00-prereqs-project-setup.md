...
```
If prompted to select a project, choose YOUR_PROJECT_ID. This operation makes your GCP project a Firebase project.
...
- Go to https://console.firebase.google.com → select project: YOUR_PROJECT_ID
