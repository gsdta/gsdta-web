# Firestore Initialization (Project: playground-personal-474821)
...
- Wrong project: Check the banner in the Firebase Console and the `--project playground-personal-474821` flag in commands.
