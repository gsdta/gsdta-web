# Seed the First Admin (Manual; Project: playground-personal-474821)
...
1) Open https://console.firebase.google.com → select project: playground-personal-474821
...
- Wrong project: Double-check the project name in the top left of the Console (should be playground-personal-474821)
