 ...
 *
 * Translation strings for English (en) and Tamil (ta).
 * These can be used by both web and mobile platforms.
 */
...
export const messages: Record<Lang, Record<string, string>> = {
    en: {
        ...
        "roles.adminReadonly": "Administrator (View Only)",
        "roles.adminReadonlyDescription": "View-only access to administrative sections.",
    ...
    ta: {
        ...
        "roles.adminReadonly": "நிர்வாகி (பார்வை மட்டும்)",
        "roles.adminReadonlyDescription": "நிர்வாக பிரிவுகளுக்கு பார்வை மட்டும் அணுகல்.",
