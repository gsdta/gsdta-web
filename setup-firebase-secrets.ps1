...
# Usage examples:
#   ./setup-firebase-secrets.ps1 -ProjectId "YOUR_PROJECT_ID" -Region "us-central1" -ServiceName "gsdta-web"
...
param(
  [Parameter(Mandatory=$false)] [string]$ProjectId = "YOUR_PROJECT_ID",
