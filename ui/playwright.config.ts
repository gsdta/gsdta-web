    ...
    webServer: [
        {
            ...
            env: {
                ...
                FIRESTORE_EMULATOR_HOST: process.env.FIRESTORE_EMULATOR_HOST || "localhost:8890",
        ...
        },
        {
            ...
            env: {
                ...
                NEXT_PUBLIC_FIRESTORE_EMULATOR_HOST: "localhost:8890",
                FIRESTORE_EMULATOR_HOST: "localhost:8890",
