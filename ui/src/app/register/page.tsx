...
const baseSchema = z.object({
  ...
  studentDob: dateISO,
  studentGender: z.enum(GENDERS, { message: "Select gender" }),
  currentPublicSchool: z.string().min(1, "Select a school"),
  schoolDistrict: z.enum(SCHOOL_DISTRICTS, { message: "Select a district" }),
  schoolDistrictOther: z.string().optional(),
  currentPublicGrade: z.enum(PUBLIC_GRADES, { message: "Select a grade" }),
  lastTamilGrade: z.enum([...TAMIL_GRADES, "Was not enrolled in Tamil school last year"] as const, { message: "Select a grade" }),
  enrollingTamilGrade: z.enum(TAMIL_GRADES, { message: "Select a grade" }),
