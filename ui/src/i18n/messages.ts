...
export const messages: Record<Lang, Record<string, string>> = {
    ...
    ta: {
        ...
        "sections.programs": "பாடிப்புத் தொடர்கள்",
        ...
        "cta.ready.title": "தொடங்க தயாரா?",
        "cta.ready.body": "வகுப்புகளைப் பார்வையிட்டு, சேர்க்கையை சில நிமிடங்களில் முடித்துவிடுங்கள்.",

        // Hero
        "hero.title": "குழந்தைகளுக்கான தமிழ்ப்பயிற்சி",
        "hero.body": "எழுத்து, வாசிப்பு, பேச்சு, எழுத்துத்தல்—நவீனக் கற்றல்முறைகளுடன் தமிழ் கற்போம்.",
        ...
        "home.carousel.hero.title": "கல்வியின் மூலம் தமிழ் பாரம்பரியத்தை வலுப்படுத்துதல்",
